...
async function main() {
    console.log(`🚀 [JS] Testing Aliyun SMTP with numeric address only`);

    const html = `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333;">
            <h2 style="color: #e63946;">Hello!</h2>
            <p>We'd love to see you again at <strong>Hot Pot 757</strong>.</p>
            <p>Your <strong>Free Boba Tea</strong> reward is ready. Simply show your phone at the store.</p>
            <p>Location: 1042 Temple Ave, 23834</p>
            <p>Phone: (804) 805-8363</p>
